...
const currencies = [
  ...
  { symbol: "BTC", name: "Bitcoin", Icon: "./public/bitcoim.svg" },
  { symbol: "ETH", name: "Ethereum", Icon: "./public/etheraum.svg" },
...
const DonatePage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-lg mb-4">Welcome to BARK donation, please fill out the form beloq. Your donation will help support various charitable organizations and causes around the world.</p>
